...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng kec = new LatLng(27.63788509, 85.33413833);
        mMap.addMarker(new MarkerOptions().position(kec).title("Kantipur Engineering Collage"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(kec));
